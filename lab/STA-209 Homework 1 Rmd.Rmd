...
2. For versicolor, it is a strong positive linear with many outliers between Sepal.Width and Sepal.Length.
3. For virginica, it is a moderate positive linear with many outliers between Sepal.Width and Sepal.Length.
